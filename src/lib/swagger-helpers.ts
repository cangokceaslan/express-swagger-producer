 ...
 */
function _objectMerge(obj1: any, obj2: any): any {
	let obj3: any = {};
 ...
 */
export function swaggerizeObj(swaggerObject: any): any {
 ...
 */
function _organizeSwaggerProperties(swaggerObject: any, pathObject: any, propertyName: any): any {
 ...
 *                          comments
 */
export function addDataToSwaggerObject(swaggerObject: any, data: any): any {
 ...
 */
function seekWrong(list: any, wrongSet: any, problems: any): any {
	let iterator: any = new RecursiveIterator(list, 0, false, 100);
 ...
 */
export function findDeprecated(sources: any): any {
	let wrong: any = _getSwaggerSchemaWrongProperties();
